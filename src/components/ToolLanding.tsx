...
export default function ToolLanding({
  ...
  return (
    <section>
      ...
      <p className="mt-3 text-[17px] leading-relaxed text-ink-muted">{intro}</p>

      <Link
        href={primaryHref}
        className="mt-6 inline-block rounded-lg bg-brand-orange px-6 py-3 text-sm font-semibold text-white transition hover:bg-brand-orange"
      >
        {primaryCta}
      </Link>

      <h2 className="mt-14 text-2xl font-semibold text-ink">
        Why use it
      </h2>
      ...
      <div className="mt-10">
        <Link
          href={primaryHref}
          className="inline-block rounded-lg bg-brand-orange px-6 py-3 text-sm font-semibold text-white transition hover:bg-brand-orange"
        >
          {primaryCta}
        </Link>
      </div>
